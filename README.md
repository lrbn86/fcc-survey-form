...
## Objective
Build a web app that functions as a survey form page with the following user stories
...
11. For the name, email, and number input fields, I can see a placeholder text that gives me a description or instructions for each field.
